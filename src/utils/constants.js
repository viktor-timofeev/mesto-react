...
const formPopupProfileEdit = document.querySelector(
  selectors.formPopupProfileEdit
);
const formPopupAddCard = document.querySelector(selectors.formPopupAddCard);
const formEditProfilePhoto = document.querySelector(
  selectors.formEditProfilePhoto
);
...
const occupationInputValue = document.querySelector(
  selectors.occupationInputValue
);
